...
on t.code = fi.code and fi.year=2018 and fi.quarter=3
...
and three.code = four.code
and four.code = five.code
and five.code = t.code
...
and four.close_pre_close_diff_amt_ratio < 0
and five.close_pre_close_diff_amt_ratio < 0
