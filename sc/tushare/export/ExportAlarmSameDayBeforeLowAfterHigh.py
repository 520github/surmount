...
class ExportAlarmSameDayBeforeLowAfterHigh(ExportBaseSqlData, object):

    trade_date = "2018-11-16"

    def __init__(self):
        self.keywords = "export_alarm_same_day_before_low_after_high"
        super(ExportAlarmSameDayBeforeLowAfterHigh, self).__init__()
        print("ExportAlarmSameDayBeforeLowAfterHigh init ")
