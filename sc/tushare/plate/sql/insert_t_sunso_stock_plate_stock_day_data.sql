...
trade_amt,net_amt,circulation_amt,turnover_rate,
continue_up_limit_days,continue_down_limit_days,
continue_up_down_days,contiune_up_down_percent,
large_above_sum_trade_amt_ratio,large_above_buy_trade_amt_ratio,large_above_sell_trade_amt_ratio,large_above_bs_trade_amt_ratio,
...
pre30_close_price_ratio,pre90_close_price_ratio,pre120_close_price_ratio,pre250_close_price_ratio,
up_limit_type,first_limit_up_time,
medium_after_buy_trade_amt_ratio,medium_after_sell_trade_amt_ratio,
medium_before_buy_trade_amt_ratio,medium_before_sell_trade_amt_ratio,
small_buy_trade_amt_ratio,small_sell_trade_amt_ratio,
...
round(t.trade_amt/100000000,6),round(t.trade_net_amt/10000,6),round(t.circulation_amt/10000,8),turnover_rate,
t.continue_up_limit_days,t.continue_down_limit_days,
t.continue_up_down_days,t.contiune_up_down_percent,
t.large_above_sum_trade_amt_ratio,t.large_above_buy_trade_amt_ratio,t.large_above_sell_trade_amt_ratio,t.large_above_bs_trade_amt_ratio,
round(t.large_above_day1_bs_diff_trade_amt/100000000,6),round(t.large_above_day1_bs_diff_trade_amt/trade_amt*100,2),
round(t.large_above_day3_bs_diff_trade_amt/100000000,6),round(t.large_above_day3_bs_diff_trade_amt/trade_amt*100,2),
round(t.large_above_day5_bs_diff_trade_amt/100000000,6),round(t.large_above_day5_bs_diff_trade_amt/trade_amt*100,2),
t.pre30_close_price_ratio,t.pre90_close_price_ratio,t.pre120_close_price_ratio,t.pre250_close_price_ratio,
t.up_limit_type,t.first_limit_up_time,
v.medium_after_buy_trade_amt_ratio,v.medium_after_sell_trade_amt_ratio,
v.medium_before_buy_trade_amt_ratio,v.medium_before_sell_trade_amt_ratio,
v.small_buy_trade_amt_ratio,v.small_sell_trade_amt_ratio,
