...
class TushareStockAbilityCashFlow(BaseFoundationYearAndQuarter, object):
    def __init__(self):
        super(TushareStockAbilityCashFlow, self).__init__()
        self.table_name = "t_tushare_stock_ability_cash_flow"
        print("TushareStockAbilityCashFlow init...")
